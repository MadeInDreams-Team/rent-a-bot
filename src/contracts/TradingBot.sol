...
contract DyDxFlashLoan is Structs {
     DyDxPool pool = DyDxPool(0x1E0447b19BB6EcFdAe1e4AE1694b0C3659614e4e);   //Main
    //   DyDxPool pool = DyDxPool(0x4EC3570cADaAEE08Ae384779B0f3A45EF85289DE);   //kovan

     address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // Main
    //address public WETH = 0xd0a1e359811322d97991e03f863a0c30c2cf029c; // Kovan

    address public SAI = 0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359; //main
   // address public SAI = 0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359; //kovan  is actualy unused dai

    address public USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; //main
    //address public USDC = 0xe22da380ee6b445bb8273c81944adeb6e8450422; //Kovan

    address public DAI = 0x6B175474E89094C44Da98b954EedeAC495271d0F; // main
    // address public DAI = 0xc4375b7de8af5a38a93548eb8453a498222c4ff2; // kovan
...
contract TradingBot is DyDxFlashLoan {
    ...
    // OneSplit Config
    address ONE_SPLIT_ADDRESS = 0xC586BeF4a0992C495Cf22e1aeEE4E446CECDee0E;// main
   // address ONE_SPLIT_ADDRESS = 0xC586BeF4a0992C495Cf22e1aeEE4E446CECDee0E;//Kovan

    uint256 PARTS = 10;
    uint256 FLAGS = 0;

    // ZRX Config mainet
     address ZRX_EXCHANGE_ADDRESS = 0x61935CbDd02287B511119DDb11Aeb42F1593b7Ef; //main
    //address ZRX_EXCHANGE_ADDRESS = 0x4eacd0af335451709e1e7b570b8ea68edec8bc97; //kovan



    address ZRX_ERC20_PROXY_ADDRESS = 0x95E6F48254609A6ee006F7D493c8e5fB97094ceF;//main
    //address ZRX_ERC20_PROXY_ADDRESS = 0xf1ec01d6236d3cd881a0bf0130ea25fe4234003e;//Kovan


     address ZRX_STAKING_PROXY = 0xa26e80e7Dea86279c6d778D702Cc413E6CFfA777; //main
    // address ZRX_STAKING_PROXY = 0xbab9145f1d57cd4bb0c9aa2d1ece0a5b6e734d34; //Kovan
    ...
    function _zrxSwap(address _from, uint256 _amount, bytes memory _calldataHexString) internal {
        ...
        // proposed fix by Lawrence | 0xLab Thank yo    
         address(ZRX_EXCHANGE_ADDRESS).call.value(tx.gasprice * 70e3)(_calldataHexString);
